#!/Users/jamesrobinson/work/data-hub-helpcentre/venv-data-hub-helpcentre/bin/python3.11
# -*- coding: utf8 -*-
...
description = (
    "Generates HTML 5 documents from standalone " "reStructuredText sources " + default_description
)
