...
def create_accessibility_page(apps, schema_editor):
    ...
    <ul class="govuk-list govuk-list--bullet">
        <li class="govuk-body">email <a class="govuk-link" href="mailto:liveservices@digital.trade.gov.uk">liveservices@digital.trade.gov.uk</a></li> <!-- #PS-IGNORE -->
    </ul>
    ...
    <p class="govuk-body">The Live Services Team is always looking to improve the accessibility of this website.
        ...
        <a class="govuk-link" href="mailto:liveservices@digital.trade.gov.uk">liveservices@digital.trade.gov.uk</a> <!-- #PS-IGNORE -->
    </p>
